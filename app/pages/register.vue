    ...
    >
      ...
      >
        <div class="flex items-center gap-3">
          ...
          />
          <span
            class="font-display text-stone-900 font-semibold text-xl tracking-tight"
            >CraftCV</span
          >
        </div>
        ...
        >
          ...
          >
            "Starting fresh felt overwhelming until I found CraftCV."
          </h2>
          <p class="text-stone-200 text-sm lg:text-base leading-relaxed">
            "The guided builder made it easy to turn a blank page into a CV I
            was proud to send out. I had interviews lined up within days."
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="w-full max-w-sm mx-auto">
        ...
        <form @submit.prevent="onFormSubmit" novalidate>
          <Transition name="step" mode="out-in">
            <div v-if="currentStep === 1" key="step-1" class="space-y-5">
              <div class="grid grid-cols-2 gap-4">
                <div class="space-y-1.5">
                  ...
                  />
                  <p v-if="fieldError('firstName')" class="text-xs text-error">
                    {{ fieldError("firstName") }}
                  </p>
                </div>
                ...
                <div class="space-y-1.5">
                  ...
                  />
                  <p v-if="fieldError('lastName')" class="text-xs text-error">
                    {{ fieldError("lastName") }}
                  </p>
                </div>
              </div>
            ...
            <div v-else key="step-3" class="space-y-5">
              <div class="space-y-1.5">
                <label
                  for="password"
                  class="block text-sm font-medium text-stone-800"
